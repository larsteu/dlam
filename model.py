...
class EMModel(nn.Module):
    def __init__(self, team_dim=32, num_leagues=10):
        ...
        self.league_weights = nn.Embedding(
            num_leagues + 1, 1
        )  # Have one extra league for leagues not in the num_leagues
    ...
    def train_epoch_to_determine_weights(
        self, epoch_idx, dataloader, loss_fn, optimizer, device
    ):
